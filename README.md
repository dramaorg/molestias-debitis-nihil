[![npm](https://img.shields.io/npm/v/@dramaorg/molestias-debitis-nihil.svg)](https://www.npmjs.com/package/@dramaorg/molestias-debitis-nihil) ![downloads](https://img.shields.io/npm/dt/@dramaorg/molestias-debitis-nihil.svg) [![CI](https://github.com/dramaorg/molestias-debitis-nihil/actions/workflows/ci.yml/badge.svg)](https://github.com/dramaorg/molestias-debitis-nihil/actions)
...
- Install by executing `npm install @dramaorg/molestias-debitis-nihil` or `yarn add @dramaorg/molestias-debitis-nihil`.
- Import by adding `import DateRangePicker from '@dramaorg/molestias-debitis-nihil'`.
...
Add React-DateRange-Picker to your project by executing `npm install @dramaorg/molestias-debitis-nihil` or `yarn add @dramaorg/molestias-debitis-nihil`.
...
import DateRangePicker from '@dramaorg/molestias-debitis-nihil';
...
```ts
import '@dramaorg/molestias-debitis-nihil/dist/DateRangePicker.css';
